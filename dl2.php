                ...
                <button type="button" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#exampleModal">
                    ...
                    <table width='80%' class="table table-success table-striped">
                        ...
                        while($user_data = mysqli_fetch_array($result)) {
                            ...
                            echo "<td><a href='edit.php?kode_mobil=$user_data[kode_mobil]'><i class='fa fa-pen text-primary'></i></a> | <a href='delete.php?kode_mobil=$user_data[kode_mobil]'><i class='fa fa-trash text-danger'></i></a></td></tr>"; 
                        }
                        ?>
                    </table>
                <!-- end crud -->
