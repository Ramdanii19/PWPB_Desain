<<?php
    ...
    if(isset($_POST['update'])) 
    {
        ...
        $result = mysqli_query($mysqli, "UPDATE sparepart SET nama_sparepart='$nama_sparepart', harga='$harga', warna='$warna', stok='$stok' WHERE kode_sparepart='".$kode_sparepart."'");
...
<?php
    ...
    $result = mysqli_query($mysqli, "SELECT * FROM sparepart WHERE kode_sparepart='".$kode_sparepart."'");
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <form name="update_user" method="post" action="editsparepart.php">
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <a href="data_sparepart.php" class="btn btn-info btn-sm"><i class="fas fa-arrow-left"></i> Kembali</a>
                                <div class="card-body">
                                    <form action="" method="post">
                                        <div class="form-group">
                                            <label for="nama_sparepart">Nama Sparepart</label>
                                            <input type="text" name="nama_sparepart" class="form-control form-control-sm" value=<?php echo $nama_sparepart;?>>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <input type="hidden" name="kode_sparepart" value=<?php echo $_GET['kode_sparepart'];?>>
