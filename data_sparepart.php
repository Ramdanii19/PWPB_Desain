...
<?php
    ...
    $result = mysqli_query($mysqli, "SELECT * FROM sparepart");
?>
...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800"><strong>Halaman Data Sparepart</strong></h1>
                    </div>
                ...
                <button type="button" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#exampleModal">
                    ...
                    <table width='80%' class="table table-success table-striped">
                        ...
                        while($user_data = mysqli_fetch_array($result)) {
                            ...
                            echo "<td><a href='editsparepart.php?kode_sparepart=$user_data[kode_sparepart]'><i class='fa fa-pen text-primary'></i></a> | <a href='deletesparepart.php?kode_sparepart=$user_data[kode_sparepart]' onClick=\"return confirm('Yakin Mau di hapus');\"><i class='fa fa-trash text-danger'></i></a></td></tr>"; 
                        }
                        ?>
                    </table>
                <!-- end crud -->
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-body">
            <form action="data_sparepart.php" method="post" name="form1">
                <table width="25%" border=0 class="table table-hover"> 
                    <tr>
                        <td><strong>Kode Sparepart</strong></td>
                        <td><input type="text" name="kode_sparepart" required></td>
                    </tr>
                    <tr>
                        <td><strong>Nama Sparepart</strong></td>
    ...
    <?php
        if(isset($_POST['Submit'])) {
            ...
            $result = mysqli_query($mysqli, "INSERT INTO sparepart(kode_sparepart,nama_sparepart,harga,warna,stok) VALUES('$kode_sparepart', '$nama_sparepart', '$harga', '$warna', '$stok')");
